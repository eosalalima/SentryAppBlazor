...
public sealed class SimulationOptions { public bool IsLiveMode { get; set; } = true; public bool EnableSimulatedLogs { get; set; } public bool EnableManualTestLogs { get; set; } public string? AdministrationKey { get; set; } [Range(1,3600)] public int MinimumDelaySeconds { get; set; } = 1; [Range(1,3600)] public int MaximumDelaySeconds { get; set; } = 10; }
